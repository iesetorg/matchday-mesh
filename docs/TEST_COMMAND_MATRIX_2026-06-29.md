...
| `npm run check:final` | Pass | Runs the one-command final recording/submission gate: launch rehearsal, DoraHacks readiness, and final submission handoff. |
...
| In-app browser final preview flow | Pass | Fresh browser run against `http://127.0.0.1:4273/` scanned Ada, opened the USDt pool, added 5 USDt, exported 6 operations, imported the log back into the UI, verified `Import Applied` and `imported 6 ops`, and saved `docs/proof/matchday-browser-preview-flow-2026-06-30.json` plus `docs/proof/matchday-browser-preview-flow-2026-06-30.jpg` with zero console errors. |
...
- final preflight runs the launch rehearsal, DoraHacks readiness, and
  submission handoff in one command before recording or page updates.
