...
| `matchday-mesh-invite-export-panel-2026-06-30.jpg` | P2P invite export fills the on-page textarea, summary panel, and pairing panel. | Browser harness with a Pear-like runtime clicked `Export Invite`; DOM contained `Invite ready to share.`, invite JSON, `read-only`, `ops 3`, `hyperswarm-topic`, and the short pairing topic, with no alert dialog. |
