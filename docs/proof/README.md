...
| `pear-release-renderer-proof-2026-06-30.json` | Released Pear link launched and wrote renderer proof for release `1958`. | `hasPear` and `hasMatchdayAPI` were true, backend was Corestore/Hyperbee, and the invite type was `matchday-mesh-core-invite-v1`; Pear's shim warning persisted because the suggested bin directory is absent on this host. |
